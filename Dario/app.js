...
var context;
let game;
var tpad = document.getElementById('controller'); //Guardamos el elemento
console.log(tpad);
class Personaje {
...
class Game {
	...
	initialize() {	
		...
		tpad.addEventListener('touchstart', e => { //Añadimos los elementos de touch al TPAD.
			...
			console.log(x);
			console.log(y);
			if (x >= 420 && x <= 500){ //Comprobamos los movimientos con coordenadas.
				if (y >= 1038 && y <= 1097){
					this.rect.y -=5;
				}else{
					this.rect.y +=5;
